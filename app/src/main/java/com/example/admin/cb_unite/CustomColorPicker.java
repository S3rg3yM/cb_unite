...
public class CustomColorPicker extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        Paint mLinearPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        Shader lShader = new LinearGradient(getHeight()/2, 0, this.getWidth()-getHeight()/2, 0, mColors, null, Shader.TileMode.REPEAT);
